...
api.add_resource(buscarProductosSubastaEjecucion, '/api/SubastaProductos1/<idSubasta>', endpoint='buscarProductosSubasta_resource')
api.add_resource(compararProductosSupermercados, '/api/ComparacionSupermercados/<idSubasta>', endpoint='compararProductosSupermercados_resource')